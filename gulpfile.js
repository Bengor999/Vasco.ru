    ...
    function pug() {
        return src([
            'app/**/*.pug'   // Берём файлы из источников
    ...
    function startwatch() {
        ...
        watch(['app/js/**/*.js', 'app/pages/**/*.js', 'app/js/libs*.js', 'app/components/**/*.js', 'app/elements/**/*.js'], scripts);
    ...
    exports.build = series(cleandist, html, pug, styles, scripts, images, assets);
